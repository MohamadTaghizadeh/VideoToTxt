...
from yolo_inference import yolo_infer
from yolo_inference import yolo_video
from yolo_inference import yolo_webcam

def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--gpu', type=int, default=0, help='gpu id')
    parser.add_argument('--mode', type=str, default='train_test', choices=['train', 'test', 'train_test', 'inference','yolo_inference','vedio','webcam'])
